"""Chapter 10 focused demo: generic case-style project layer."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Chapter 10 generic case-style demo")
    ...
    parser.add_argument("--case-style", choices=["generic", "operator", "public"], default="generic", help="Case wording style for chapter 10")
    parser.add_argument("--subgraph-label", type=str, default="toy decoder subgraph", help="Readable label for the migrated subgraph")
